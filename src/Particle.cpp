...
Particle::Particle()
{
	fPid = 0;
	fCharge = 0;
	fBx = fBy = fPx = fPy = fPz = fdEdx = fdEdxVtpc1 = fdEdxVtpc2 = fdEdxMtpc = fNdEdx = fNdEdxVtpc1 = fNdEdxVtpc2 = fNdEdxMtpc = 0.;
}
...
Particle::Particle(UInt_t pid, Short_t charge, 
			...
			Float_t ndedx, Float_t ndedx_vtpc1, Float_t ndedx_vtpc2, Float_t ndedx_mtpc)
{
	fPid = pid;
	fCharge = charge;
	fBx = bx;
