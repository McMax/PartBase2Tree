...
void Event::AddParticle(UInt_t pid, Short_t charge, Float_t bx, Float_t by, Float_t px, Float_t py, Float_t pz, Float_t dedx, Float_t dedx_vtpc1, Float_t dedx_vtpc2, Float_t dedx_mtpc, Float_t ndedx, Float_t ndedx_vtpc1, Float_t ndedx_vtpc2, Float_t ndedx_mtpc)
{
